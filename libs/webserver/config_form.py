...
CONFIG_FORM_SECTIONS = (
    ...
    },
    {
        ...
        'fields': (
            ...
            {'section': 'Print', 'option': 'MAX_COPIES', 'label': 'Maximum copies per print', 'control': 'number', 'number_type': 'int', 'min': 1, 'max': 10, 'step': 1, 'help': 'Sheets a guest can ask for at once. A template that duplicates its collage prints two photos per sheet. Set to 1 to hide the selector.'},
